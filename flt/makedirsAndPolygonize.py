...
#  Purpose:  Application for converting raster data to a vectorToRaster polygon layer.
...
if __name__ == '__main__':
    # 定义要创建的目录
    mkpath = 'E:/pythontest/python_gdal_testdata/shp/'
    # 调用函数
    mkdir(mkpath)
    ...
    quiet_flag = 0
    src_filename = 'E:/pythontest/python_gdal_testdata/ab.tif'
    src_band_n = 1

    dst_filename = 'E:/pythontest/python_gdal_testdata/shp/classvec.shp'
    dst_layername = None
    dst_fieldname = None
    dst_field = -1
